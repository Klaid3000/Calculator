...
function App() {
	...
	const actionButtons = [
		{ label: '+', action: actionSymbolPlus },
		{ label: '-', action: actionSymbolMinus },
	...
	function calculateResult() {
		if (result === `${num1} + ${num2}` && num1 !== '' && num2 !== '') {
			...
			setNum2('');
		} else if (result === `${num1} - ${num2}` && num1 !== '' && num2 !== '') {
					...
					<div className={styles.result}>
						...
						<p
							className={`${styles.resultText} ${
								displayColor ? styles.resultColor : ''
							}`}
						>
							{result}
						</p>
